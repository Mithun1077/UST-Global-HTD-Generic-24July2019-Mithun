...
public class Dataset {
	...
	public static void main(String[] args) {
		...
		do {
			System.out.println(
					"enter 1 to Addcontact and show all contacts // enter 2 to search // enter 3 operate on contact");
			int i = sc.nextInt();
			switch (i) {
			case 1:
